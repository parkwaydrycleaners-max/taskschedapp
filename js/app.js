...
renderWhiteboard() {
 ...
 if (this.viewDays > 1) {
 container.className = 'flex-shrink-0 mr-6 pb-4 border-r-4 border-dashed border-gray-300 pr-6';
 }
 ...
 dateBadgeClass = 'bg-gray-400 text-white ';
 } else {
 ...
 <button class="add-task-btn p-1 hover:bg-gray-200 :bg-gray-700 rounded transition-colors" title="Add Order" data-person="${person}" data-date="${this.dateToLocalDateString(date)}">
 <svg class="w-4 h-4 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
 </svg>
 </button>

 <button class="quick-capacity-header-btn p-1 hover:bg-purple-100 :bg-purple-900/30 rounded text-purple-500 transition-colors" title="Quick Capacity Override" data-person="${person}" data-date="${this.dateToLocalDateString(date)}">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
 </svg>
 </button>
 <button class="snap-cards-btn p-1 hover:bg-green-100 :bg-green-900/30 rounded text-green-500 transition-colors" title="Snap Cards to Top" data-person="${person}" data-date="${this.dateToLocalDateString(date)}">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button class="quick-capacity-btn hover:bg-gray-200 :bg-gray-700 px-2 py-1 rounded transition-colors text-left w-full"
