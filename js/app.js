    ...
    console.log('🚀 Task Scheduler Pro initialized');
            ...
            createDayContainer(date, dayOffset) {
                ...
                if (this.viewDays > 1) {
                    ...
                    dayHeader.className = 'text-center p-2 bg-gray-100 dark:bg-gray-700 rounded-t-lg mb-2 font-semibold';
            ...
            createPersonColumn(person, date, dayOffset) {
                ...
                column.className = 'flex-shrink-0 person-column w-[268px] bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700';
                    ...
                    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="flex space-x-1">
                                <button class="add-task-btn p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors" title="Add Order" data-person="${person}" data-date="${this.dateToLocalDateString(date)}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                </button>

                                <button class="quick-capacity-header-btn p-1 hover:bg-purple-100 dark:hover:bg-purple-900 rounded text-purple-500 transition-colors" title="Quick Capacity Override" data-person="${person}" data-date="${this.dateToLocalDateString(date)}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                </button>
                                <button class="snap-cards-btn p-1 hover:bg-green-100 dark:hover:bg-green-900 rounded text-green-500 transition-colors" title="Snap Cards to Top" data-person="${person}" data-date="${this.dateToLocalDateString(date)}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">
                            <button class="quick-capacity-btn hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1 rounded transition-colors text-left w-full" 
            ...
            createTaskCard(task, person, date) {
                ...
                const isOverCapacity = task.position >= capacity || (task.position + task.duration) > capacity;
                
                let bgColor, borderColor;
                if (task.completed) {
                    bgColor = 'bg-green-100 dark:bg-green-900';
                    borderColor = isOverCapacity ? 'border-red-500 border-2' : 'border-green-300 dark:border-green-600';
                } else {
                    bgColor = 'bg-yellow-100 dark:bg-yellow-900';
                    borderColor = isOverCapacity ? 'border-red-500 border-2' : 'border-yellow-300 dark:border-yellow-600';
                }
                ...
                const overCapacityIcon = isOverCapacity ? '<span class="text-red-500 ml-1" title="Over capacity">⚠</span>' : '';
                    ...
                    <div class="flex flex-col h-full px-3 pt-2 pb-3">
                        ...
                        ${showDescription ? `
                            <div class="flex-1 min-h-0">
                                <div class="text-xs text-gray-600 dark:text-gray-400 leading-tight overflow-hidden" 
                        ...
                        statusDiv.innerHTML = `
                            <div class="bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg p-3 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-green-700 dark:text-green-300 font-medium">🖨️ DirectPrint Extension Active</span>
                                </div>
                                <p class="text-sm text-green-600 dark:text-green-400 mt-1">Tags will print directly to your thermal printer without browser dialogs.</p>
                            </div>
                        `;
                    } else {
                        statusDiv.innerHTML = `
                            <div class="bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700 rounded-lg p-3 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-yellow-700 dark:text-yellow-300 font-medium">⚠️ DirectPrint Extension Not Available</span>
                                </div>
                                <p class="text-sm text-yellow-600 dark:text-yellow-400 mt-1">Install the Chrome extension for direct printing. Tags will use browser print dialog as fallback.</p>
                            </div>
                        `;
                    }
                }, 100);
                ...
                const helpModal = this.createModal('🔧 Install DirectPrint Extension', `
                    <div class="space-y-4 text-sm">
                        <div class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                            <h4 class="font-semibold text-blue-800 dark:text-blue-200 mb-3">📋 Installation Steps</h4>
                            <ol class="list-decimal list-inside space-y-2 text-blue-700 dark:text-blue-300">
                                ...
                                <li>Open Chrome and go to <code class="bg-blue-100 dark:bg-blue-800 px-1 rounded">chrome://extensions/</code></li>
                        ...
                        <div class="bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                            <h4 class="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">⚡ Extension Features</h4>
            ...
            updateTagTable(quantity) {
                ...
                for (let i = 1; i <= quantity; i++) {
                    ...
                    row.innerHTML = `
                        <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-100">${i}</td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">${this.currentTagData.task.orderNumber}</td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">${this.currentTagData.person}</td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">${dayName}</td>
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">${formattedWorkDate}</td>
                        <td class="px-4 py-3">
                            <input type="text" class="tag-custom-info w-full p-2 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700" 
            ...
            updateTagPreview() {
                ...
                tagInputs.forEach((input, index) => {
                    ...
                    tagPreview.className = 'border border-gray-300 dark:border-gray-600 rounded p-3 bg-white dark:bg-gray-800 text-sm';
                    tagPreview.innerHTML = `
                        ...
                        ${customInfo ? `<div class="mt-2 font-medium text-blue-600 dark:text-blue-400">${customInfo}</div>` : ''}
                        <div class="mt-2 text-xs text-gray-500 dark:text-gray-400">${this.currentTagData.task.description}</div><div></div><div></div>
                    `;
...
showOrderModalForPerson(person, date = null) {
    ...
    this.updateCommonWords();
            ...
            updateCompletionStatusDisplay(isCompleted) {
                ...
                if (isCompleted) {
                    statusText.innerHTML = '<span class="text-green-600 dark:text-green-400">✅ Completed</span>';
                    ...
                    statusText.innerHTML = '<span class="text-yellow-600 dark:text-yellow-400">⏳ In Progress</span>';
        ...
        this.handleProductionError(error, 'saveOrder');
            ...
            renderCommonWords(commonWords, container) {
                ...
                commonWords.forEach(word => {
                    ...
                    btn.type = 'button';
                    btn.className = 'px-2 py-1 text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors';
            ...
            switchSettingsTab(tab) {
                ...
                databaseTab.className = 'px-4 py-2 text-sm font-medium border-b-2 border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 rounded-t';
                peopleTab.className = 'px-4 py-2 text-sm font-medium border-b-2 border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 rounded-t';
                editTextTab.className = 'px-4 py-2 text-sm font-medium border-b-2 border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 rounded-t';
                databaseContent.classList.add('hidden');
                peopleContent.classList.add('hidden');
                editTextContent.classList.add('hidden');
                
                if (tab === 'database') {
                    databaseTab.className = 'px-4 py-2 text-sm font-medium border-b-2 border-primary text-primary bg-gray-50 dark:bg-gray-700 rounded-t';
                    databaseContent.classList.remove('hidden');
                } else if (tab === 'people') {
                    peopleTab.className = 'px-4 py-2 text-sm font-medium border-b-2 border-primary text-primary bg-gray-50 dark:bg-gray-700 rounded-t';
                    peopleContent.classList.remove('hidden');
                    this.updateCurrentPeopleList();
                } else if (tab === 'editText') {
                    editTextTab.className = 'px-4 py-2 text-sm font-medium border-b-2 border-primary text-primary bg-gray-50 dark:bg-gray-700 rounded-t';
            ...
            updateCurrentPeopleList() {
                ...
                if (this.people.length === 0) {
                    container.innerHTML = '<p class="text-gray-500 dark:text-gray-400 text-sm">No people added yet.</p>';
                    return;
                }
                
                this.people.forEach(person => {
                    const personCard = document.createElement('div');
                    personCard.className = 'flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border';
                    ...
                    personCard.innerHTML = `
                        <div class="flex-1">
                            <div class="font-medium text-gray-900 dark:text-gray-100">${person}</div>
            ...
            showConnectionStatus(message, isError = false) {
                ...
                statusDiv.textContent = message;
                statusDiv.className = `p-3 rounded-lg text-sm ${isError ? 'bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300' : 'bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300'}`;
            ...
            displaySearchResults(results, container) {
                ...
                statsDiv.className = 'text-center py-2 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-600 mt-4';
...
createSearchResultItem(result) {
    ...
    item.className = 'p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors';
    
    item.innerHTML = `
        <div class="flex justify-between items-start mb-2">
            <div class="text-lg font-semibold text-primary">#${task.orderNumber}</div>
            <div class="text-sm text-gray-500 dark:text-gray-400">${task.duration * 15} min</div>
        </div>
        <div class="text-sm text-gray-600 dark:text-gray-300 mb-2">${task.description}</div>
        <div class="flex justify-between items-center text-xs mb-2">
            <div class="flex space-x-4">
                <span class="text-gray-500 dark:text-gray-400">📅 Work: ${correctWorkDateDisplay}</span>
            ...
            displayReport(reportData, selectedPerson, startDate, endDate, filterType) {
                ...
                table.innerHTML = `
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Person</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Description</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Work Date</th>
                ...
                reportData.forEach((item, index) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">${item.person}</td>
                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 max-w-xs truncate" title="${item.task.description}">${item.task.description}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">${item.workDateDisplay}</td>
...
showExportOptionsModal() {
    ...
    modal.innerHTML = `
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Choose your export format:</p>
            
            <div class="space-y-3">
                <button id="exportCSV" class="w-full p-3 text-left bg-blue-50 hover:bg-blue-100 dark:bg-blue-900 dark:hover:bg-blue-800 border border-blue-200 dark:border-blue-700 rounded-lg transition-colors">
                    <div class="font-medium text-blue-800 dark:text-blue-200">💾 CSV File</div>
                    <div class="text-xs text-blue-600 dark:text-blue-400">Standard spreadsheet format</div>
                </button>
                
                <button id="exportThermal" class="w-full p-3 text-left bg-orange-50 hover:bg-orange-100 dark:bg-orange-900 dark:hover:bg-orange-800 border border-orange-200 dark:border-orange-700 rounded-lg transition-colors">
                    <div class="font-medium text-orange-800 dark:text-orange-200">🖨️ Thermal Printer</div>
                    <div class="text-xs text-orange-600 dark:text-orange-400">Optimized for thermal receipt printers</div>
                </button>
            </div>
            
            <div class="flex justify-end space-x-3 mt-6">
                <button id="cancelExport" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">Cancel</button>
            </div>
        </div>
    `;
        ...
        document.body.removeChild(modal);
            ...
            showMiniCalendar() {
                ...
                weekDays.forEach(day => {
                    calendarHTML += `<div class="p-2 text-center text-sm font-medium text-gray-500 dark:text-gray-400">${day}</div>`;
                });
                calendarHTML += '</div>';
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-sm w-full mx-4 fade-in">
                        <div class="flex items-center justify-between mb-4">
                            <button class="prev-month p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                                </svg>
                            </button>
                            <h3 class="text-lg font-semibold">${monthNames[currentMonth]} ${currentYear}</h3>
                            <button class="next-month p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                            ...
                            <button class="close-calendar px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors">Close</button>
                        </div>
                    </div>
                `;
                    ...
                    <div class="space-y-4 text-sm">
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <ul class="space-y-2">
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">T</kbd> Go to Today</li>
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">←</kbd> Previous Day</li>
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">→</kbd> Next Day</li>
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">1/2/3</kbd> Switch View</li>
                                </ul>
                            </div>
                            <div>
                                <h4 class="font-semibold mb-3 text-primary">Actions</h4>
                                <ul class="space-y-2">
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Ctrl+N</kbd> New Order</li>
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Ctrl+F</kbd> Search</li>
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Ctrl+R</kbd> Reports</li>
                                    <li><kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Ctrl+Shift+S</kbd> Settings</li>
                                </ul>
                            </div>
                        </div>
                        <div class="pt-3 border-t border-gray-200 dark:border-gray-600">
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                Press <kbd class="px-1 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs">?</kbd> or 
                                <kbd class="px-1 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs">H</kbd> anytime to show this help
                            </p>
                        </div>
                    </div>
                `, { maxWidth: 'max-w-2xl' });
            ...
            showDatePicker() {
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4 fade-in">
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            <button class="cancel-date-picker px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">Cancel</button>
            ...
            createModal(title, content, options = {}) {
                ...
                const closeButtonHTML = showCloseButton ? `
                    <button class="modal-close absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 p-1 transition-colors">
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl ${maxWidth} w-full mx-4 relative max-h-[90vh] overflow-y-auto fade-in ${className}">
                        ${closeButtonHTML}
            ...
            showRemovePersonConfirmation(person) {
                ...
                const message = `
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">This will hide them from the current view but keep all their data intact.</p>
                `;
            ...
            showCapacityModal(person) {
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-lg w-full mx-4 fade-in">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Each slot = 15 minutes. 32 slots = 8 hours max.</p>
                            </div>
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            <button class="cancel-capacity px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">Cancel</button>
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-lg w-full mx-4 max-h-[80vh] overflow-y-auto fade-in">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button class="close-details text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 p-1 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                </svg>
                            </button>
                        ...
                        <div class="space-y-4">
                            ...
                            ${isOverdue ? 
                                '<div class="bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg p-3"><p class="text-red-800 dark:text-red-200 text-sm font-medium">⚠️ This order is overdue</p></div>' : 
                                ''
                            }
                        </div>
                        ...
                        <div class="flex justify-between items-center mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                            ...
                            <button class="close-details px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                Close
                            </button>
                        </div>
                    </div>
            ...
            showQuickCapacityModal(person, dateKey) {
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4 fade-in">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                                <div class="text-sm text-gray-600 dark:text-gray-400">Person:</div>
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            <button class="cancel-quick-capacity px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">Cancel</button>
            ...
            showCapacityOverridesModal(person) {
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto fade-in">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-lg font-semibold">📅 Capacity Overrides for ${person}</h3>
                            <button class="close-overrides text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 p-1 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                </svg>
                            </button>
                        ...
                        <div>
                            ...
                            <div id="overridesList" class="space-y-2">
                                ${sortedDates.length === 0 ? 
                                    '<p class="text-gray-500 dark:text-gray-400 text-sm">No capacity overrides set.</p>' :
                                        ...
                                        return `
                                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                                                <div>
                                                    ...
                                                    <div class="text-sm text-gray-500 dark:text-gray-400">${capacity} slots (${Math.floor(capacity * 15 / 60)}h ${(capacity * 15) % 60}m)</div>
                                                </div>
                        ...
                        <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                            <button class="close-overrides px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">Close</button>
                        </div>
                    </div>
                `;
                ...
                modal.innerHTML = `
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4 fade-in">
                        ...
                        <input type="password" id="quickApiKey" placeholder="Enter your Airtable API Key" 
                               class="w-full p-3 text-base border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:ring-2 focus:ring-primary focus:border-transparent mb-4">
                        <div class="flex justify-end space-x-3">
                            <button class="cancel-quick-setup px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">Cancel</button>
            ...
            showTaskContextMenu(event, task) {
                ...
                menu.className = 'fixed bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-xl py-2 min-w-[160px]';
                ...
                menuItems.forEach(item => {
                    if (item.divider) {
                        ...
                        divider.className = 'h-px bg-gray-200 dark:bg-gray-600 my-1';
                        menu.appendChild(divider);
                    } else {
                        const menuItem = document.createElement('button');
                        menuItem.className = `w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center space-x-3 ${item.className || ''}`;
                        menuItem.innerHTML = `
            ...
            setupEnhancedAutoComplete() {
                ...
                const createAutocompleteList = () => {
                    ...
                    autocompleteList.className = 'absolute top-full left-0 right-0 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-48 overflow-y-auto z-50 mt-1';
                ...
                const showSuggestions = (suggestions) => {
                    ...
                    suggestions.forEach((suggestion, index) => {
                        const item = document.createElement('div');
                        item.className = 'px-3 py-2 text-sm cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 border-b border-gray-100 dark:border-gray-600 last:border-b-0';
                        item.textContent = suggestion.text;
                        item.dataset.index = index;
                        
                        if (suggestion.isPartial) {
                            item.innerHTML += ' <span class="text-xs text-gray-500 dark:text-gray-400">(partial match)</span>';
                        }
                ...
                const updateSelection = (direction) => {
                    ...
                    if (selectedIndex >= 0) {
                        items[selectedIndex].classList.add('bg-blue-100', 'dark:bg-blue-900');
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            async verifyTaskDeletion(taskId) {
                try {
                    const tableName = encodeURIComponent(this.airtableConfig.tablesConfig.tasks);
                    await this.makeAirtableRequest(`${tableName}/${taskId}`);
                ...
                const message = `
                    <div class="text-center">
                        <div class="mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">📅 Capacity Overrides Setup</h3>
                        </div>
                        <div class="text-left space-y-3 text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded border mt-3 mb-3">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">Without this table, capacity overrides only save locally and won't sync between browsers or devices.</p>
                        </div>
                        <div class="mt-6">
